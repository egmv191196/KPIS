...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-07-2021 a las 13:28:36
...
(1, 1, 'Levantamientos', 15, 10, 'TEC-102'),
(2, 2, 'Topografía', 25, 10, 'TEC-102'),
(3, 3, 'Batimetría', 35, 15, 'TEC-102'),
(4, 4, 'Construcción', 25, 25, 'TEC-102'),
(5, 1, 'Topografía', 35, 15, 'Tabasco-102'),
(6, 2, 'Levantamientos', 10, 0, 'Tabasco-102'),
(7, 3, 'Construcción', 50, 0, 'Tabasco-102'),
(8, 4, 'Batimetría', 5, 20, 'Tabasco-102'),
(9, 1, 'Batimetría', 25, 15, 'asdsad'),
(10, 2, 'Geotecnia', 30, 25, 'asdsad'),
(11, 3, 'Levantamientos', 10, 15, 'asdsad'),
(12, 4, 'Geotecnia', 15, 50, 'asdsad'),
(13, 5, 'Construcción', 20, 25, 'asdsad'),
(14, 1, 'Construcción', 30, 50, 'LT-012'),
(15, 2, 'Levantamientos', 35, 25, 'LT-012'),
(16, 3, 'Topografía', 35, 0, 'LT-012'),
(17, 1, 'Topografia', 15, 0, 'Jalisco'),
(18, 2, 'Obra Civil', 25, 15, 'Jalisco'),
(19, 3, 'LEvantamientos', 60, 0, 'Jalisco'),
(20, 1, 'Levantamiento', 15, 10, 'Sin-1058'),
(21, 2, 'BAtimetria', 25, 0, 'Sin-1058'),
(22, 3, 'Topografia', 35, 0, 'Sin-1058'),
(23, 4, 'Obra Civil', 25, 0, 'Sin-1058'),
(24, 1, 'Levantamiento', 15, 0, 'Oax-110'),
(25, 2, 'Obra', 25, 0, 'Oax-110'),
(26, 3, 'Geotecnia', 35, 0, 'Oax-110'),
(27, 4, 'Supervision', 25, 0, 'Oax-110');
...
(1, 'Hola', '', 'fdsfdsfsd@gmail.com', 1232142141, 1),
...
INSERT INTO `proyecto` (`clave_Proyecto`, `Nombre`, `fecha_Inicio`, `fecha_Fin`, `monto_Contrato`, `monto_Gastado`, `monto_Pagado`, `id_Presupuesto`, `Estado`, `id_Cliente`) VALUES
('asdsad', 'Zaragoza', '2021-07-12', '2021-10-26', 100000, 15000, 0, 'Pres-102', 1, 8),
('Jalisco', 'Construccion Tlaquepaque', '2020-07-10', '2021-11-25', 100000, 35000, 0, 'Tla-105', 1, 3),
('LT-012', 'Huawei Playa del carmen', '2021-07-05', '2022-07-05', 100000, 50000, 0, 'PR-155', 1, 50),
('Oax-110', 'Carretera Oaxaca', '2021-07-15', '2022-07-15', 250000, 10000, 25000, 'Oax-Pres', 1, 7),
('Sin-1058', 'Sinaloa Carretera', '2020-10-10', '2022-10-10', 250000, 100000, 0, 'Sin-pres', 1, 5),
('Tabasco-102', 'Supervisión Tabasco', '2021-05-12', '2022-05-12', 50000, 10000, 0, 'Tab-02', 1, 8),
('TEC-102', 'Mercado de Tecamachalco', '2020-05-06', '2022-05-06', 100000, 25000, 0, 'tec-02-pres', 1, 5);
...
(110, 'LeoGC', 'R19A', '2021-07-17', 20000, 2021, 28),
(111, 'LeoGC', 'R15A', '2021-07-17', 25000, 2021, 7),
(112, 'LeoGC', 'R16A', '2021-07-17', 15000, 2021, 28),
(113, 'LeoGC', 'R17A', '2021-07-17', 10000, 2021, 28),
(114, 'LeoGC', 'R21A', '2021-07-17', 15000, 2021, 28),
(115, 'LeoGC', 'R22A', '2021-07-17', 18000, 2021, 28),
(116, 'LeoGC', 'R20A', '2021-07-17', 50000, 2021, 7),
(117, 'LeoGC', 'R22A', '2021-07-10', 15000, 2021, 27),
(118, 'LeoGC', 'R22A', '2021-07-03', 18000, 2021, 26),
(119, 'LeoGC', 'R22A', '2021-06-26', 25000, 2021, 25),
(120, 'LeoGC', 'R22A', '2021-06-19', 45000, 2021, 24),
(121, 'LeoGC', 'R22A', '2021-06-12', 38000, 2021, 23),
(122, 'JosaGG', 'R4B', '2021-07-17', 15, 2021, 7),
(123, 'JosaGG', 'R4A', '2021-07-17', 10, 2021, 7),
(125, 'JosaGG', 'R5A', '2021-07-17', 10, 2021, 14),
(126, 'JosaGG', 'R5A', '2021-07-03', 5, 2021, 13),
(127, 'JosaGG', 'R1B', '2021-07-17', 6, 2021, 14),
(128, 'JosaGG', 'R1A', '2021-07-17', 10, 2021, 14),
(129, 'JosaGG', 'R1A', '2021-07-03', 12, 2021, 13),
(130, 'JosaGG', 'R1B', '2021-07-03', 8, 2021, 13),
(131, 'JosaGG', 'R6B', '2021-07-17', 10, 2021, 14),
(132, 'JosaGG', 'R11A', '2021-07-17', 35, 2021, 14),
(133, 'JosaGG', 'R11A', '2021-07-03', 25, 2021, 13),
(134, 'JosaGG', 'R11A', '2021-06-19', 45, 2021, 12),
(135, 'JosaGG', 'R11A', '2021-06-05', 20, 2021, 11),
(140, 'EsmeGT', 'R28A', '2021-07-27', 5, 2021, 30),
(149, 'EsmeGT', 'R27A', '2021-07-29', 5, 2021, 30),
(150, 'EsmeGT', 'K01', '2021-07-29', 15, 2021, 30),
(151, 'EsmeGT', 'K02', '2021-07-29', 25, 2021, 30),
(152, 'EsmeGT', 'K03', '2021-07-29', 25, 2021, 30);
...
--
ALTER TABLE `conceptos`
  MODIFY `id_Concepto` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `registroindicadores`
  MODIFY `id_registro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=153;
