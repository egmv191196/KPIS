...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-07-2021 a las 18:27:53
...
INSERT INTO `proyecto` (`clave_Proyecto`, `Nombre`, `fecha_Inicio`, `fecha_Fin`, `monto_Contrato`, `monto_Gastado`, `id_Presupuesto`, `Estado`, `id_Cliente`) VALUES
('asdsad', 'Zaragoza', '2021-07-12', '2021-10-26', 100000, 15000, 'Pres-102', 1, 8),
('Jalisco', 'Construccion Tlaquepaque', '2020-07-10', '2021-11-25', 100000, 35000, 'Tla-105', 1, 3),
('LT-012', 'Huawei Playa del carmen', '2021-07-05', '2022-07-05', 100000, 50000, 'PR-155', 1, 50),
('Oax-110', 'Carretera Oaxaca', '2021-07-15', '2022-07-15', 250000, 0, 'Oax-Pres', 1, 7),
('Sin-1058', 'Sinaloa Carretera', '2020-10-10', '2022-10-10', 250000, 100000, 'Sin-pres', 1, 5),
('Tabasco-102', 'Supervisión Tabasco', '2021-05-12', '2022-05-12', 50000, 10000, 'Tab-02', 1, 8),
('TEC-102', 'Mercado de Tecamachalco', '2020-05-06', '2022-05-06', 100000, 25000, 'tec-02-pres', 1, 5);
...
(124, 'JosaGG', 'R10A', '2021-07-17', 1, 2021, 7),
...
(148, 'EsmeGT', 'R27A', '2021-07-27', 10, 2021, 30);
...
--
ALTER TABLE `registroindicadores`
  MODIFY `id_registro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;
