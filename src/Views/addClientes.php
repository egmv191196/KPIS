...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">  
        ...
        <form id="frmCliente" method="POST">
                ...
                <input type="email" name="Email" class="form-control " id="Correo" placeholder="Email">  
                ...
                <input type="button" class="btn btn-danger float-right m-3 center btn-lg" onclick="addClientes();" value="Agregar clientes">
